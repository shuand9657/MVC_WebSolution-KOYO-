    ...
    var routeResolver = function () {
        ...
        this.routeConfig = function () {
            var viewsDirectory = '../templates/',
                controllersDirectory = '/Scripts/Script/',
        ...
        this.route = function (routeConfig) {
            ...
            var resolve = function (baseName, path, controllerAs, secure) {
                ...
                var routeDef = {};
                var splitName = baseName.split("/");
                var baseFileName = baseName.charAt(0).toLowerCase() + baseName.substr(1);
                routeDef.templateUrl = routeConfig.getViewsDirectory() + path + splitName[0]+splitName[1] + '.html';
                routeDef.controller = splitName[0]+splitName[1] + 'Controller';
